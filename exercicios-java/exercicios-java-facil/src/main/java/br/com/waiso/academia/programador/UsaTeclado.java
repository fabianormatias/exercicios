...
public class UsaTeclado {
	...
	public static void main(String args[]) {
		...
		// pede para o usuario entrar com o nome, idade e salario da linha de
		// comando
		...
		System.out.printf("Nome informado: %s %n", nome); // %s string, %n
															// quebra linha
		System.out.printf("Idade informada: %d %n", idade); // %d int (decimal)
		System.out.printf("Salario informado: %.2f %n", salario); // %f double
																	// ou float
	}
