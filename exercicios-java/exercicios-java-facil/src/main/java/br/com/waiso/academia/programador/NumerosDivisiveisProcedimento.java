 ...
 * 
 * Em Java um "procedimento" é um bloco de código que processa instruções, mas
 * no fim (conclusão) não retorna resultado.
 *
 * Java não tem suporte a procedimentos, na verdade criamos um método com tipo
 * de retorno 'void'.
 *
 * Objetivos: - uso de procedimento para computar instruções; - uso de escopo de
...
public class NumerosDivisiveisProcedimento {
	...
	/*
	 * Bloco de código que centraliza as instruções que calculam possíveis
	 * divisores de um número. Ao chamar esse procedimento, é necessário
	 * informar o número minimo e maximo que devem ser analisados, além do
	 * divisor. Exemplo imprimeDivisiveis(1, 10, 2) -> computa os divisiveis por
	 * 2 de 1 a 10.
	 */
