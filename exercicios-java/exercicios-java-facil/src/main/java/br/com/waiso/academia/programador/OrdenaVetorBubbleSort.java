...
public class OrdenaVetorBubbleSort {
	...
	/*
	 * Procedimento responsável preencher o array a partir dos dados coletados
	 * via teclado.
	 */
	...
	/*
	 * Procedimento responsável por ordenar o array, utilizando o algoritmo
	 * Bubble Sort. No fim do procedimento os números contidos no array estarão
	 * em ordem numérica.
	 */
