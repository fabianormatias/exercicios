 ...
 *
 * Objetivos: - uso de arrays que armazenam números; - uso do comando for para
 * preencher e percorrer arrays; - todo array possui a propriedade length, que
 * indica q qtde de elementos armazenados;
 *
...
public class VetoresNumeros {
	...
	public static void main(String[] args) {
		...
		// o Java define o comando for each, mais simples de iterar sob os
		// elementos do array
		for (float n : notas) {
		...
		/*
		 * A seguir um exemplo de codigo que define e carrega um array com nros
		 * pares. O maior nro armazenado é 100, o processamento ocorre na ordem:
		 * 100, 98, 96, 94... Os nros são mantidos em ordem ascendente (2, 4, 6,
		 * 8...), note a lógica inversa
		 */
		int maiorPar = 100;
