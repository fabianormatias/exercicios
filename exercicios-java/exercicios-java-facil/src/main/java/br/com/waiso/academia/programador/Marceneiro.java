...
/**
 * Programa Java otimiza o trabalho do Marceneiro, uma vez definido o tamanho da
 * peça (pedaço) o programa calculas quantas peças dentro uma metragem maior
 * (taboas). Dessa forma o Marceiro pode escolher qual a melhor metragem de
 * taboa.
 *
 * Objetivos: - exercício de lógica;
 *
...
public class Marceneiro {
	...
	/*
	 * Procedimento recebe o tamanho da taboa (em centímetros), calcula quantas
	 * peças podem cortadas e quanto sobra.
	 */
