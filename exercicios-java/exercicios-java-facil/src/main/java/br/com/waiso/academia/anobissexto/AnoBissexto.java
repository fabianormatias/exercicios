 ...
 * Bissexto.
 *
 * Objetivos: - uso de funções; - uso de expressões booleanas (c/ if); - uso de
...
public class AnoBissexto {
	...
	/*
	 * Função recebe como argumento o ano, e retorna boolean indicando se ou nao
	 * bissexto.
	 */
	static boolean ehBissexto(int ano) {
		return ano % 4 == 0 && ano % 100 != 0 || ano % 400 == 0;

		// o trecho a seguir (comentado) é uma outra solução para verificar
		// bissexto, com ifs:
