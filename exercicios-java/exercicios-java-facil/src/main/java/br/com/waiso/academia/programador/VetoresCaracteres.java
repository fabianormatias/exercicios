 ...
 *
 * Objetivos: - uso de arrays que armazenam caracteres (char e String); - uso do
 * comando for para preencher e percorrer arrays; - todo array possui a
 * propriedade length, que indica q qtde de elementos armazenados;
 *
...
public class VetoresCaracteres {
	...
	public static void main(String[] args) {
		...
		/*
		 * Trecho a seguir cria um vetor que armazena o alfabeto, com as letras
		 * Maísculas em ordem decrescente (de Z a A).
		 */
