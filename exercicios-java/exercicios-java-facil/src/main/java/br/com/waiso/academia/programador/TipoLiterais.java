...
/**
 * Programa Java demonstra opções de literais suportas pela linguagem. É
 * possível atribuir valores para numeros, utilizando: decimal, octal,
 * hexadecimal e binário. Já para char além do tradicional é possível utilizar
 * essas 4 opções. O Java suporta Unicode, portanto podemos declarar conteúdo
 * char com código Unicode.
 *
 * Objetivos: - uso de literais suportadas pelo Java;
 *
...
public class TipoLiterais {
	...
	public static void main(String[] args) {
		...
		System.out.println("hexadecimal = " + hexadecimal); // tb imprime como
															// decimal
