...
/**
 * Programa Java demonstra como declarar e preencher vetores (array). Um array é
 * uma variável que pode armazenar vários valores, organizados por um índice. No
 * Java a capacidade de um array é estática, ou seja, uma vez definida a
 * capacidade de um array não pode mudar. Portanto, adicionar ou remover
 * elementos podem requerer a criação de um novo array, com capacidade maior ou
 * menor.
 *
 * Objetivos: - uso de arrays;
 *
