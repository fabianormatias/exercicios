...
/**
 * Programa Java demonstra como declarar variáveis de tipos: boolean, char e
 * String.
 *
 * Objetivos: - declaração de variáveis;
 *
...
public class DeclaraVarOutros {
	...
	public static void main(String[] args) {
		...
		String frase = "Ola " + palavra;// o operador '+' concatena o conteúdo
										// das strings
